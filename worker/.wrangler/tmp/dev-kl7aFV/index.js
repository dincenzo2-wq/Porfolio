...
// .wrangler/tmp/bundle-EwkI7f/checked-fetch.js
  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/settings" && request.method === "POST") {
        ...
        await env.DB.prepare("INSERT OR REPLACE INTO settings (id, name, profession, slogan, avatar, accentColor, categories) VALUES (1, ?, ?, ?, ?, ?, ?)").bind(s.name, s.profession, s.slogan, s.avatar, s.accentColor, JSON.stringify(s.categories || [])).run();
        return new Response(JSON.stringify({ success: true }), { headers: corsHeaders });
      }
...
// .wrangler/tmp/bundle-EwkI7f/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EwkI7f/middleware-loader.entry.ts
